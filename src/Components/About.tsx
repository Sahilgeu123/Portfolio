...
function About() {
  ...
  return (
    <section
      id="about"
      className="scroll-hidden min-h-screen w-full  lg:flex-col flex flex-row justify-between pl-10 nope "
    >
      <div className="about flex sm:flex-col lg:flex-row lg:ml-25">
        <div className="lg:mt-40 sm:mt-30">
          ...
          <div className="flex flex-col gap-3 mt-10 mb-10">
            ...
            <p className="p1 relative">
              ...
              <p className="font-bold absolute left-95 top-[18px] text-lg hidden sm:flex ">CGPA:8/10</p>
            </p>
          </div>
        </div>
        <div className="maincard rounded-4xl p-5 flex justify-center items-center lg:ml-20 ">
          <div className="card relative flex bg-[#f1edfb] lg:mt-10 text2 border-3 border-[#3d315c] rounded-4xl  shadow-gray-500 shadow-md  h-130 w-100">
            <div className=" pr-9">
