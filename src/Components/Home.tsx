...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      <div className="ani4 flex justify-center gap-10 mt-10">
      ...
      <div className="ani5 flex flex-row justify-center items-center gap-10 mt-16">
      <a
...
>
  ...
  />
      ...
      <div className="size-8 mt-15 rounded-full ani5 ">
        <img
